    ...
    return (
        <div style={{ padding: 'var(--spacing-xl)' }}>
            <div style={{ marginBottom: 'var(--spacing-xl)' }}>
                <h2 className="text-3xl font-bold text-primary">Exportar Dados</h2>
            ...
            <Card style={{ marginTop: 'var(--spacing-xl)' }}>
                <h3 className="text-lg font-semibold text-primary" style={{ marginBottom: 'var(--spacing-md)' }}>
                ...
                <div className="grid grid-cols-2 gap-lg">
                    <div>
                        ...
                        <ul style={{
                            ...
                            <li><strong>Excel:</strong> Para análise de dados, edição ou compartilhamento</li>
                            <li><strong>PDF:</strong> Para relatórios formais, impressão ou arquivamento</li>
                            <li><strong>Backup:</strong> Para segurança e restauração de dados</li>
                        </ul>
                    </div>
