            ...
            >
              ...
              <div>
                <p
                  ...
                  style={{ color: resultado.success ? 'var(--success-700)' : 'var(--danger-700)' }}
                >
                ...
                <p
                  ...
                  style={{
                    ...
                    color: resultado.success ? 'var(--success-600)' : 'var(--danger-600)',
                  }}
                >
                  {resultado.message}
                </p>
        ...
        <Card title="Instruções">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
            ...
            >
              ...
              <p
                className="text-sm"
                style={{ marginTop: 'var(--spacing-xs)', color: 'var(--warning-600)' }}
              >
                A importação irá adicionar novos registros. Certifique-se de que não há duplicatas
                no arquivo.
              </p>
            </div>
          </div>
